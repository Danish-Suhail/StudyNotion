...
//         if( currentValues.courseTitle !== course.courseName||
//             currentValues.courseShortDesc !== course.courseDescription||
//             currentValues.coursePricee !== course.price||
//             currentValues.courseTitle !== course.courseName||
//             // currentValues.courseTags.toString() !== course.tag.toString()||
//             currentValues.courseBenefits !== course.whatYouWillLearn||
//             currentValues.courseCategory._id !== course.category._id||
...
//         <div className='relative'>
//             <label htmlFor='coursePrice'>Course Price<sup>*</sup></label>
//             <input id='coursePrice' placeholder='Enter course Price' {...register('coursePrice',{
//                 required:true,
//                 valueAsNumber:true,
...
//         {/* create a componenet for uploading and showing thumbnail of media */}
